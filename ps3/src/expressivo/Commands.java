 ...
 * 
 * <p>
 * PS3 instructions: this is a required class.
 ...
 * You may, however, add additional static methods, or strengthen the specs of
 * existing methods.
 */
public class Commands {
     ...
     *         expression equal
     *         to the derivative, but doesn't need to be in simplest or canonical
     *         form.
    ...
    public static String differentiate(String expression, String variable) {
        try {
            ...
            throw new IllegalArgumentException("Invalid expression or variable", e);
        }
    }
     ...
     *                    case-sensitive nonempty
     *                    strings of letters. The set of variables in environment is
     *                    allowed to be different than the
     *                    set of variables actually found in expression. Values must
     *                    be nonnegative numbers.
     * @return an expression equal to the input, but after substituting every
     *         variable v that appears in both
     *         the expression and the environment with its value,
     *         environment.get(v). If there are no
     *         variables left in this expression after substitution, it must be
     *         evaluated to a single number.
     *         Additional simplifications to the expression may be done at the
    ...
    public static String simplify(String expression, Map<String, Double> environment) {
        try {
            ...
            throw new IllegalArgumentException("Invalid expression or environment", e);
        }
    }
